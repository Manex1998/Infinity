...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <h5 class="author" style="color: #c92b87">{{ $post->author }}<span class="date" style="color: #000; margin-left: 4px; ">{{ \Carbon\Carbon::parse($post->published_at)->format('Y F d') }}</span></h5>
                <div>
                    <div class="image">
