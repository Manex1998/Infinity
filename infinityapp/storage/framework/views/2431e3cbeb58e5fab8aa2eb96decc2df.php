   ...
   <section class="hero-section">
        <header class="header d-flex"> 
            ...
            <div class="brand">
                <div class="logo" data-aos="fade-up" data-aos-offset="0">
                    <img src="<?php echo e(asset('icons/logo.png')); ?>" alt="Infinity Logo">
                </div>
            ...
            <div class="hero">
                ...
                <nav class="navbar" data-aos="fade-down" data-aos-offset="0">
                    <ul class="navlist" id="navlist">
                        ...
                        <li><a href="<?php echo e(url('/articlelist')); ?>" class="nav_link">Articles</a></li>
                ...
                <div class="about_background d-flex flex-column">
                    ...
                    <div class="about_slider" data-aos="fade-up" data-aos-offset="0">
                        ...
                        <ul class="icons_list d-flex flex-row gap-3">
                             ...
                             <li class="list_item">
                                <img src="<?php echo e(asset('icons/info.png')); ?>"></img>
                            </li>

                            <li class="list_item">
                                <img src="<?php echo e(asset('icons/send.png')); ?>"></img>
                            </li>

                            <li class="list_item">
                                <img src="<?php echo e(asset('icons/target.png')); ?>"></img>
                            </li>

                            <li class="list_item">
                                <img src="<?php echo e(asset('icons/diamond (1).png')); ?>"></img>
                            </li>
                        </ul>
                ...
                <div class="services_background">
                    ...
                    <div class="services_slider" data-aos="fade-up" data-aos-offset="0">
                        ...
                        <ul class="icons_list d-flex flex-row gap-3">
                            ...
                            <li class="list_item">
                                <img src="<?php echo e(asset('icons/independence.png')); ?>"></img>
                            </li>

                            <li class="list_item">
                                <img src="<?php echo e(asset('icons/people.png')); ?>"></img>
                            </li>

                            <li class="list_item">
                                <img src="<?php echo e(asset('icons/compliant.png')); ?>"></img>
                            </li>

                            <li class="list_item">
                                <img src="<?php echo e(asset('icons/relationship.png')); ?>"></img>
                            </li>
                        </ul>
    ...
    <section id="contact" class="contact">
                ...
                <div class="contact_section mt-5 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200" data-aos-offset="0">
                    ...
                    <form class="contact_form d-flex flex-column gap-1" action="<?php echo e(route('contact')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Manu\Documents\Web dev\Projects\IFINITY\infinityapp\resources\views/index.blade.php ENDPATH**/ ?>