            ...
            <div class="row">
                    ...
                    <div class="row trending_post_list mt-2 justify-content-around">
                        ...
                        <?php $__currentLoopData = $trending; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="trending_post col-12 col-md-4 mb-4">
                                <a href="/article/<?php echo e($post->slug); ?>">
                                    <h5 class="author"><?php echo e($post->author); ?></h5>
                                    <h1 class="article_title"><?php echo e($post->title); ?></h1>
                                    <p class="date"><?php echo e(\Carbon\Carbon::parse($post->published_at)->format('Y F d')); ?></p>
                                </a>
                            </div>
                ...
                <div class="opinion_collection">
                    <div class="row trending_post_list mt-2 justify-content-around">
                        ...
                        <?php $__currentLoopData = $opinion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="/article/<?php echo e($post->slug); ?>">
                                    <div class="video">
                                            <iframe width="100%" height="100%" 
                                                src="<?php echo e($post->youtube_embed_url); ?>"
                                                frameborder="0"
                                                allowfullscreen > 
                                            </iframe>
                                    </div>
                                    <h1 class="video-title"><?php echo e($post->title); ?></h1>
                                </a>
                            </div>
...
</html><?php /**PATH C:\Users\Manu\Documents\Web dev\Projects\IFINITY\infinityapp\resources\views/articlelist.blade.php ENDPATH**/ ?>